        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="text-[10px] uppercase tracking-widest text-slate-400 border-b border-slate-100 dark:border-slate-800">
              ...
              <th className="pb-2 font-black text-right">Probability of Progression<br /><span className="text-[9px] font-normal">with latest labwork</span></th>
              <th className="pb-2 font-black text-right">Probability of Progression<br /><span className="text-[9px] font-normal">with history labwork</span></th>
            </tr>
          </thead>
